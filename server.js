...
async function start() {
  const { getPool } = await import('./telegram-mini-app/api/_lib/db.js');
  const { verifyTelegramData, parseTelegramUser } = await import('./telegram-mini-app/api/_lib/telegram.js');
